...
const SettingsWindow = (props) => {
    ...
    const { authUser, signInWithGoogle, signOut } = props;
        ...
        <div>
            ...
            <Card header='Profile'>
                ...
                <div className={styles.authButtons}>
                    {(!authUser || authUser.isAnonymous) && <GoogleAuthBtn clickHandler={signInWithGoogle} />}
                    <button className={`button is-dark ${styles.outButton}`} onClick={signOut}>
